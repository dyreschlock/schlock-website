...
public class V2Reviews extends AbstractVersion2Page
{
    @Inject
    ...
    public String getCurrentPostLink()
    {
        ...
        return linkSource.createPageRenderLinkWithContext(V2Reviews.class, uuid).toURI();

    }

    public String getCategoryName()
    {
        AbstractPost post = this.post;
        if (post == null)
        {
            post = currentPost;
        }
